...
q_dict = {
    'q0': {
        ...
        'raw-original-answers': {'moon': 1, 'earth': 1, 'comet': 1, 'sun': 1, 'clouds': 1, 'meteor': 1, 'asteroid': 1, 'planet': 1, 'star': 1},
        'raw-answers-cleaned': {'moon': 1, 'earth': 1, 'comet': 1, 'sun': 1, 'clouds': 1, 'meteor': 1, 'asteroid': 1, 'planet': 1, 'star': 1},
    ...
    'q1': {
        ...
        'raw-original-answers': {'aaple': 1, 'banana': 1, 'broccoli': 2, 'na': 1, 'wheat': 1, 'fruit': 1, 'fruits': 1, 'vegetable': 1, 'fruit or vegetable': 1},
        'raw-answers-cleaned': {'apple': 1, 'banana': 1, 'broccoli': 2, 'na': 1, 'wheat': 1, 'fruit': 2, 'fruits': 1, 'vegetable': 1},
        'answers-cleaned': {
...
crowdsource_test_data = (
    ('exact_match', ['fruit', 'vegetable'], q_dict['q1']['answers-cleaned'], {'family_feud': 1.0, 'fast_money': 1.0, 'set_intersection': 1.0, 'hard_lcsubstring_set_int': 1.0, 'hard_lcsubseq_set_int': 1.0, 'hard_lcsubstring': 1.0, 'hard_lcsubseq': 1.0}),
    ('misspelling', ['aaple', 'brocoli'], q_dict['q1']['answers-cleaned'], {'family_feud': 0.0, 'fast_money': 0.0, 'set_intersection': 0.0, 'hard_lcsubstring_set_int': 0.5, 'hard_lcsubseq_set_int': 1.0, 'hard_lcsubstring': 5/8, 'hard_lcsubseq': 1.0}),
    ('single_element_category', ['moon'], q_dict['q0']['answers-cleaned'], {'family_feud': 1/8, 'fast_money': 1/3, 'set_intersection': 1/4}),
    ('no_category_label_points', ['space rock'], q_dict['q0']['answers-cleaned'], {'family_feud': 0.0, 'fast_money': 0.0, 'set_intersection': 0.0, 'hard_lcsubstring': 0.0, 'hard_lcsubseq': 0.0}),
    ('multiple_possible_assignments', ['broccoli/banana', 'an apple'], q_dict['q1']['answers-cleaned'], {'family_feud': 0.0, 'fast_money': 0.0, 'set_intersection': 0.0, 'hard_lcsubstring': 1.0, 'hard_lcsubseq': 1.0}),
    ('no_double_points_for_surface_forms', ['apple', 'banana', 'fruit', 'fruits'], q_dict['q1']['answers-cleaned'], {'family_feud': 5/8, 'fast_money': 1.0, 'set_intersection': 1/2, 'hard_lcsubstring': 5/8, 'hard_lcsubseq': 5/8}),
    ('no_double_points_for_partial_matches', ['apple', 'aapple', 'appple', 'apples'], q_dict['q1']['answers-cleaned'], {'family_feud': 5/8, 'fast_money': 1.0, 'set_intersection': 1/2, 'hard_lcsubstring': 5/8, 'hard_lcsubseq': 5/8}),
    ('no_match', ['a', 'b', 'c', 'd', 'e'], q_dict['q0']['answers-cleaned'], {'family_feud': 0, 'fast_money': 0, 'set_intersection': 0, 'hard_lcsubstring': 0, 'hard_lcsubseq': 0}),
)
